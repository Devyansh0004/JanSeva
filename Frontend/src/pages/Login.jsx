      ...
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl overflow-hidden mt-10">
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">Log in to track resources and coordination.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <a href="#" className="text-xs text-emerald-600 hover:text-emerald-700">Forgot password?</a>
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          <div className="mt-6 border-t border-gray-100 pt-6">
            <button
              ...
              className="w-full bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 font-medium py-3 rounded-xl transition-colors flex items-center justify-center space-x-2"
            >
